...
server.tool("hello-world", "Returns a simple hello world message", {}, async () => ({
    content: [{ type: "text", text: "hello world" }]
}));
server.tool("submit-stripe-payment", "Submits card data to Stripe using the StripeTester automation.", {
