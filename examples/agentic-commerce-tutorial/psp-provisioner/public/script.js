...
function setupEventListeners() {
    ...
    document.getElementById('load-sample').addEventListener('click', function() {
        // WARN: Returning the full error object from the Stripe API (error.response?.data) directly to the client can leak sensitive information about your system's internal state or configuration. This is a security risk. It's much safer to log the detailed error on the server for debugging and return a generic, non-descriptive error message to the client.
